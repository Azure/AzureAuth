...
Note that this process is only necessary within a web app, and only when using an interactive authentication flow. In a normal R session, or when using the client credentials flow, you should be able to call `get_azure_token` directly.
