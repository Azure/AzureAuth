...
#' @export
get_authorization_uri <- function(endpoint, ...)
{
    UseMethod("get_authorization_uri")
}


#' @rdname get_authorization_uri
#' @export
get_authorization_uri.default <- function(endpoint="https://login.microsoftonline.com/", tenant, resource, app,
                                      password=NULL, username=NULL, ..., version=1)
{
    ...
    get_authorization_uri(endpoint, resource, app, password, username, ...)
}


#' @rdname get_authorization_uri
#' @export
get_authorization_uri.aad_endpoint <- function(endpoint, resource, app, password=NULL, username=NULL, ...)
{
