#' @rdname AzureToken
#' @export
AzureTokenAuthCode <- R6::R6Class("AzureTokenAuthCode",
    inherit = AzureToken,
    public = list(
...
#' @rdname AzureToken
#' @export
AzureTokenDeviceCode <- R6::R6Class("AzureTokenDeviceCode",
    inherit = AzureToken,
    public = list(
...
#' @rdname AzureToken
#' @export
AzureTokenClientCreds <- R6::R6Class("AzureTokenClientCreds",
    inherit = AzureToken,
    public = list(
    ...
    private = list(
        ...
        set_request_credentials = function(app, password, certificate) {
            ...
            if (!is.null(password)) {
                ...
                stop("Must provide either a client secret or certificate for client_credentials grant",
                    call. = FALSE
                )
            }
...
#' @rdname AzureToken
#' @export
AzureTokenOnBehalfOf <- R6::R6Class("AzureTokenOnBehalfOf",
    inherit = AzureToken,
    public = list(
    ...
    private = list(
        ...
        set_request_credentials = function(app, password, certificate, on_behalf_of) {
            ...
            if (!is.null(password)) {
                ...
                stop("Must provide either a client secret or certificate for on_behalf_of grant",
                    call. = FALSE
                )
            }
...
#' @rdname AzureToken
#' @export
AzureTokenResOwner <- R6::R6Class("AzureTokenResOwner",
    inherit = AzureToken,
    public = list(
        initialize = function(common_args) {
...
#' @rdname AzureToken
#' @export
AzureTokenManaged <- R6::R6Class("AzureTokenManaged",
    inherit = AzureToken,
    public = list(
    ...
    private = list(
        initfunc = function(init_args) {
            ...
            headers <- if (secret != "") {
                ...
                httr::add_headers(metadata = "true")
            }
