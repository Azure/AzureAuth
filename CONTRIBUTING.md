Contributions to **AzureAuth** are welcome from anyone and are best sent as pull requests on [the GitHub repository](https://github.com/cloudyr/AzureAuth/). This page provides some instructions to potential contributors about how to add to the package.

 1. Contributions can be submitted as [a pull request](https://help.github.com/articles/creating-a-pull-request/) on GitHub by forking or cloning the [repo](https://github.com/cloudyr/AzureAuth/), making changes and submitting the pull request.
 ...
 5. Non-trivial contributions need to be noted in the `Authors@R` field in the [DESCRIPTION](https://github.com/cloudyr/AzureAuth/blob/master/DESCRIPTION). Just follow the format of the existing entries to add your name (and, optionally, email address). Substantial contributions should also be noted in [`inst/CITATION`](https://github.com/cloudyr/AzureAuth/blob/master/inst/CITATION).
 ...
 7. Please run `R CMD BUILD AzureAuth` and `R CMD CHECK AzureAuth_VERSION.tar.gz` before submitting the pull request to check for any errors.
...
Some specific types of changes that you might make are:
 ...
 3. New functionality. This is fine, but should be discussed on [the GitHub issues page](https://github.com/cloudyr/AzureAuth/issues) before submitting a pull request.
 
 3. Changes requiring a new package dependency should also be discussed on [the GitHub issues page](https://github.com/cloudyr/AzureAuth/issues) before submitting a pull request.
